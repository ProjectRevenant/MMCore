...
public final class CurrentWrapper implements VersionWrapper {
  ...
  public void sendPacketOpenWindow(Player player, int containerId, String inventoryTitle) {
    toNMS(player).connection.send(new ClientboundOpenScreenPacket(containerId, MenuType.ANVIL, Component.literal(inventoryTitle)));
  }
  ...
  public void addActiveContainerSlotListener(Object container, Player player) {
    toNMS(player).openMenu(new SimpleMenuProvider((a, b, c) -> (AnvilMenu) container, Component.literal("nil")));
  }
