...
public enum TextureModel {
  ...
  WET_EFFECT(Material.STICK, 4500, false, false, false, FontMeta.of(18,0, "bitmap")),
  WET_EFFECT_SMALL(Material.STICK, 4501, false, false, false),
  DRY_EFFECT(Material.STICK, 4502, false, false, false, FontMeta.of(18,0, "bitmap")),
  DRY_EFFECT_SMALL(Material.STICK, 4503, false, false, false),
  HUNGER_DEBUFF(Material.STICK, 4504, false, false, false, FontMeta.of(18,0, "bitmap")),
  HUNGER_DEBUFF_SMALL(Material.STICK, 4505, false, false, false),
  THIRST_DEBUFF(Material.STICK, 4506, false, false, false, FontMeta.of(18,0, "bitmap")),
  THIRST_DEBUFF_SMALL(Material.STICK, 4507, false, false, false),
  OVERWEIGHT_DEBUFF_I(Material.STICK, 4508, false, false, false, FontMeta.of(18,0, "bitmap")),
  OVERWEIGHT_DEBUFF_I_SMALL(Material.STICK, 4509, false, false, false),
  OVERWEIGHT_DEBUFF_II(Material.STICK, 4510, false, false, false, FontMeta.of(18,0, "bitmap")),
  OVERWEIGHT_DEBUFF_II_SMALL(Material.STICK, 4511, false, false, false),
  CAMPFIRE_BUFF(Material.STICK, 4512, false, false, false, FontMeta.of(18,0, "bitmap")),
  CAMPFIRE_BUFF_SMALL(Material.STICK, 4513, false, false, false),
  OVERHEAT_DEBUFF(Material.STICK, 4514, false, false, false, FontMeta.of(18,0, "bitmap")),
  OVERHEAT_DEBUFF_SMALL(Material.STICK, 4515, false, false, false),
  UNDERCOOL_DEBUFF(Material.STICK, 4516, false, false, false, FontMeta.of(18,0, "bitmap")),
  UNDERCOOL_DEBUFF_SMALL(Material.STICK, 4517, false, false, false),
  SALT_POISONING(Material.STICK, 4518, false, false, false, FontMeta.of(18,0, "bitmap")),
  SALT_POISONING_SMALL(Material.STICK, 4519, false, false, false),
  FOOD_POISONING(Material.STICK, 4520, false, false, false, FontMeta.of(18,0, "bitmap")),
  FOOD_POISONING_SMALL(Material.STICK, 4521, false, false, false),
  BROKEN_BONE(Material.STICK, 4522, false, false, false, FontMeta.of(18,0, "bitmap")),
  BROKEN_BONE_SMALL(Material.STICK, 4523, false, false, false),
  HEAD_BROKEN_BONE(Material.STICK, 4524, false, false, false, FontMeta.of(18,0, "bitmap")),
  HEAD_BROKEN_BONE_SMALL(Material.STICK, 4525, false, false, false),
  TORSO_BROKEN_BONE(Material.STICK, 4526, false, false, false, FontMeta.of(18,0, "bitmap")),
  ...
  SALT_WATER_BOTTLE(Material.POTION, 6002, false, false, false),
  EMPTY_WATER_BOTTLE(Material.CLAY_BALL, 6003, false, false, false),

  TAB_ICON_SERVER(Material.STICK, 3500, false, false, false, tabFont()),
  TAB_ICON_BODY(Material.STICK, 3501, false, false, false, tabFont()),
  TAB_ICON_STATS(Material.STICK, 3502, false, false, false, tabFont()),
  TAB_ICON_EFFECTS(Material.STICK, 3503, false, false, false, tabFont()),
  REVENANT_TITLE(Material.ACACIA_BOAT, 3504, false, false, false, FontMeta.of(128, 50, "bitmap"));
